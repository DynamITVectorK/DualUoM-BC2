...
///
/// Esta codeunit centraliza exactamente dos responsabilidades:
...
/// No debe haber lógica de signo DUoM dispersa en otros codeunits salvo justificación explícita.
/// </summary>
