...
codeunit 50216 "DUoM Cost Price Tests"
{
    ...
    begin
        ...
        // Crear y contabilizar el diario de artículos para inicializar el inventario
...

{
    ...
    begin
        ...
        LibraryInventory.PostItemJournalLine(LibraryInventory.SelectItemJournalTemplateName(ItemJnlTemplateName, ItemJnlTemplateName::Item), LibraryInventory.SelectItemJournalBatchName(ItemJnlTemplateName));
