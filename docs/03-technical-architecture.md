...
| `DUoM Doc Transfer Helper` | 50105 | Helper centralizado de copia/proyección de campos DUoM entre líneas de documento. En posting sin tracking, proyecta con prorrateo proporcional sobre la cantidad efectivamente registrada: en compra mantiene signo de entrada según IJL y en venta fuerza signo negativo técnico de salida al proyectar desde `Sales Line` hacia `Item Journal Line`. |
